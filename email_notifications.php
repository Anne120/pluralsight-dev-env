...
<div id="modules" class="container text-center">
  ...
  <div class="alert alert-info fade in">
    ...
    <strong>Info!</strong> Check Table below if you have have any <b>Unseen</b> Email Notifications. Enjoy Your day!.
  </div>

  <h3>KENYA'S FARMING ADVISORY SYSTEM </h3>
  <h4>Email Notifications from Admin</h4>
  <br>
...
<div class="table-responsive" style="padding-top: 25px;">             
  <table class="table table-striped" id="trackingDetails">
    ...
    <tbody>
       <?php                
        $result = mysqli_query($connect, "SELECT * FROM email_notification WHERE receiver_farmer = '$username'"); 
      ...
      <tr>
        ...
        <td>
        	<a href="includes/accept.inc.php?accept=<?php echo $row['appointment_id']; ?>" class="btn btn-success"><span class="glyphicon glyphicon-ok"></span> Seen</a>        	        	
        </td>                     
      </tr>         
      <?php
        }
