...
<div class="container">
  ...
  <div class="row">
    <div class="col-sm-6">
    <div class="page-header">
      <h3 class="text-center">Land Hectares</h3>      
  </div>

<form method="post" action="land_price_two.php">
<div class="form-group">          
  <input type="text" name="new_amount" id="address" placeholder="Enter New Amount for Hectare Price" class="form-control" required="required">
</div>
<button type="submit" class="btn btn-success btn-block" style="margin-top: 28px; float: right;" name="update">Update Cost</button>
</form>
