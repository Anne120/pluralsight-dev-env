...
<!-- Sidebar -->  
  ...
  <table class="table table-striped" id="trackingDetails">
    ...
    <tbody>
       <?php                
        $result = mysqli_query($connect, "SELECT * FROM farmers"); 
      ...
      <tr>
        ...
        <td> 
        <div class="btn-group">         
          <a href="edit_farmer.php?edit_id=<?php echo $row['farmers_id']; ?>" class="btn btn-success"><span class="glyphicon glyphicon-edit"></span> Edit</a>
          <a href="includes/delete_farmer.inc.php?delete_id=<?php echo $row['farmers_id']; ?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Delete</a>
          </div>         
        </td>          
      </tr>         
      <?php
