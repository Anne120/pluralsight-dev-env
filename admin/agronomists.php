...
<!-- Sidebar -->  
  ...
  <table class="table table-striped" id="trackingDetails">
    ...
    <tbody>
       <?php                
        $result = mysqli_query($connect, "SELECT * FROM agronomists"); 
      ...
      <tr>
        ...
        <td>
          <div class="btn-group">         
          <a href="edit_agronomists.php?edit_id=<?php echo $row['agronomist_id']; ?>" class="btn btn-success"><span class="glyphicon glyphicon-edit"></span> Edit</a>
          <a href="includes/detele_agronomist.inc.php?delete_id=<?php echo $row['agronomist_id']; ?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Delete</a>
          </div>         
        </td>               
      </tr>         
      <?php
