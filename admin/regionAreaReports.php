...
<script type="text/javascript"> 
    function ExcelReport() 
  {
    ...
    $('#export').attr('download', 'KENYA'S. Report file.xls');
  }
</script>
...
<div class="container">
    ...
    <nav class="navbar navbar-inverse">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="regions.php"><span class="glyphicon glyphicon-dashboard"></span> Back to Region Reports</a>
        </div>
  ...
  <table class="table table-striped" id="trackingDetails">
    <thead>
      <tr>
        <th>RegionName</th>
        <th>Area</th>
        <th>PercentageLandArea</th>        
        <th>AnnualRainfall</th>
        <th>FarmingSystems</th>
      </tr>
    </thead>
    <tbody>
       <?php
       if (isset($_POST['regionArea'])) {
        $area = mysqli_real_escape_string($connect,$_POST['area']);
        $result = mysqli_query($connect, "SELECT * FROM regions WHERE area = '$area'"); 
      ...
      <tr>
        ...
        <td><?Php echo $row['percentage_land_area']; ?></td>
        <td><?Php echo $row['annual_rainfall']; ?></td>        
         <td><?Php echo $row['farming_systems']; ?></td>                    
      </tr>         
      <?php
       }
        }
    ...
    <tbody>
      <tr>
        ...
        <td>
         <div class="form-group" style="padding-top: 8px; padding-bottom: 8px;">
            ...
            <select class="form-control" id="sel1" name="region_names" required="required" disabled>
        ...
        <td>
          <button type="submit" name="regionNames" class="btn btn-success"><span class="glyphicon glyphicon-thumbs-up" disabled></span> Report</button>
        </td>  
        </form>    
      </tr>
      ...
      <tr>
        ...
        <div class="form-group">         
          <select class="form-control" id="sel1" name="region_area" required="required" disabled>
        ...
        <td>
          <button type="submit" name="regionArea" class="btn btn-success"><span class="glyphicon glyphicon-thumbs-up" disabled></span> Report</button>
        </td>  
        </form>    
      </tr>
