...
<!-- Sidebar -->  
  ...
  <div class="col-md-9" id="main-content">
    ...
    <div class="page-header text-center">
      <h3>Administrators | Add Admin</h3>      
    </div>
    <form role="form" method="post" action="includes/admin.inc.php">
     <div class="col-md-6">
        ...
        <div class="form-group">
          ...
          <input type="text" name="surname" id="surname" class="form-control" pattern="^[a-zA-Z ]*$" title="Letters Only" placeholder="Enter Name" required="required">          
        </div>      
     ...
     <div class="col-md-6">
      ...
      <button type="submit" class="btn btn-success btn-block" style="margin-top: 28px; float: right;" name="saveAdmin">Add Admin</button>
     </div>
     </form>
    </div>
