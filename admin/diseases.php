...
<div class="container">
    ...
    <nav class="navbar navbar-inverse">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="diseases_two.php"><span class="glyphicon glyphicon-dashboard"></span> Proceed to Table</a>
        </div>
...
<div class="page-header">
      <h3 class="text-center">Add Diseases, Symptoms, Causes and Solutions</h3>      
  </div>

<form method="post" action="diseases_two.php">
<div class="form-group">          
  <input type="text" name="disease" id="address" placeholder="Enter Disease Name" class="form-control" required="required">
<div class="form-group">          
  <input type="text" name="symptoms" id="address" placeholder="Enter Disease Symptoms" class="form-control" required="required">
</div>
<div class="form-group"> 
<input type="text" name="cause" id="address" placeholder="Enter Disease Causes" class="form-control" required="required">
</div>
<div class="form-group"> 
<input type="text" name="solution" id="address" placeholder="Enter Disease Solution" class="form-control" required="required">
</div>
<div class="form-group"> 
<input type="text" name="solution" id="address" placeholder="Enter Disease Image" class="form-control" required="required">
</div>
<button type="submit" class="btn btn-success btn-block" style="margin-top: 28px; float: right;" name="add">Add Disease Details</button>
</form>
