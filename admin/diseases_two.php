...
<div class="container">
    ...
    <nav class="navbar navbar-inverse">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="diseases.php"><span class="glyphicon glyphicon-dashboard"></span> Back to Adding Diseases</a>
        </div>
  ...
  <table class="table table-striped" id="trackingDetails">
    ...
    <tbody>
       <?php                
        $result = mysqli_query($connect, "SELECT * FROM diseases"); 
