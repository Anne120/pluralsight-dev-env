	...
	<div class="row">
		...
		<div class="col-sm-8">
		     ...
		     ?>				    
			    ...
			    <p style="font-size: 120%;">Symptoms Selected: <span class="label label-primary"><?php echo $symptomsRow2['symptoms']; ?></span></p>
			    <p style="font-size: 120%;">Cause: <span class="label label-danger"><?php echo $symptomsRow2['cause']; ?></span></p>
			    <p style="font-size: 120%;">Solution: <span class="label label-danger"><?php echo $symptomsRow2['solution']; ?></span></p>
				<?php echo "<div id = 'img_div'> " ; ?>
				<p style="font-size: 120%;">Image: <span class="label label-one"> <?php echo "<img src='".$symptomsRow2['Image']. "'> "?></span></p>
