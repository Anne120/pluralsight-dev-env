	...
	{	
	    ...
	    {	        
	      echo("<script type='text/javascript'>
	            ...
	            location='../chats.php?chat=upload_failed';
	            </script>"); 
	          	$uploadOk = 0;
	    }
	    // Check file size
	    ...
	    // if everything is ok, try to upload file
	            ...
	            $sqlQuery = mysqli_query($connect, "UPDATE `farmers` SET image_upload = '$image' WHERE username = '$username'");     
	                
	            echo("<script type='text/javascript'>
	                alert('Profile image uploaded successfully!');
	                location='../chats.php?chat=upload_success';
	                </script>");
		    	}
		    	else{
		    		echo("<script type='text/javascript'>
