...
<nav class="navbar navbar-inverse" style="color: white">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
        ...
        <li class="active1"><a href="blog.html">Blog</a></li>
...
<div id="modules" class="container text-center">
  ...
  <div class="tab-content">
      ...
      <?php 
        ...
        { 
          echo "<div class='well text-left' style='background-color: #f5fff2; border-color: #518e40; border-radius: 10px;'>
                ...
                <img src='uploaded_images/".$agro_row['image_upload']."' class='img-circle' alt='Chicago' width='30px' height='30px'> ". $agro_row['username'] ."</a></div>";
        }  
      ?>            
    </div>
    <div id="profile" class="tab-pane fade">
      ...
      ?>
      <img src='uploaded_images/<?php echo $agro_row3['image_upload']; ?>' class='img-circle' alt='Chicago' width='200px' height='200px'>       
