    	...
    	<div class="page-header">
		 ...
		 <p class="text-center">
		 	<?php 
				...
				echo $fetchRegionFromDb['region_name']; 
			?>
		 </p>    
    </div>
  <div class="col-sm-6">
    	<div class="page-header">
		 ...
		 <p class="text-center">
		 	<?php 
			    ...
			    $regionsQuery = mysqli_query($connect, "SELECT * FROM regions WHERE region_name ='$region'");
				$fetchRegionFromDb = mysqli_fetch_assoc($regionsQuery);
				echo $fetchRegionFromDb['average_temperature']; 
			?>
		 </p>    
    </div>
	<div class="col-sm-6">
    	<div class="page-header">
		 ...
		 <p class="text-center">
		 	<?php 
			    ...
			    $regionsQuery = mysqli_query($connect, "SELECT * FROM regions WHERE region_name ='$region'");
				$fetchRegionFromDb = mysqli_fetch_assoc($regionsQuery);
				echo $fetchRegionFromDb['soil_type']; 
			?>
		 </p>    
    </div>
    <div class="col-sm-6">
    ...
    <div class="col-sm-6">
		 ...
		 <?php 
			    ...
			    $regionsQuery = mysqli_query($connect, "SELECT * FROM regions WHERE region_name ='$region'");
				$fetchRegionFromDb = mysqli_fetch_assoc($regionsQuery);
				echo $fetchRegionFromDb['soil_ph']; 
			?>	
    </div>   
	<div class="col-sm-6">
    	<div class="page-header">
		 ...
		 <p class="text-center">
		 	<?php 
			    ...
			    $regionsQuery = mysqli_query($connect, "SELECT * FROM regions WHERE region_name ='$region'");
				$fetchRegionFromDb = mysqli_fetch_assoc($regionsQuery);
				echo $fetchRegionFromDb['suggested_crops']; 
			?>
		 </p>    
    </div> 
  </div>  
