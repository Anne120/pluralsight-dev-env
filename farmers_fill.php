  ...
  <div class="row">
    ...
    <div class="col-sm-4">
		...
		<div class="form-group">
			...
			<input type="text" name="cell-number" id="cell-number" class="form-control" pattern="^\+?\d{0,3}\s?\(?\d{4}\)?[-.\s]?\d{3}[-.\s]?\d{3}?" title="Must be Kenya MNO Numbers Only" placeholder="Enter Cellphone Number" required="required">
		</div>
    </div>
    <div class="col-sm-8">
...
<footer class="text-center">
  ...
  <p>&copy; <?php echo date("Y");?> <a href="#" data-toggle="tooltip" title="Visit ZIMDEF.">Kenya Manpower Development Fund.
</footer>
