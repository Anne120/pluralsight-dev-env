  ...
  <div class="text-left" style="display: inline;">
    ...
    <div class="col-sm-6">        
      <div class="form-group">
        ...
        <input type="text" name="phone" id="phone" class="form-control" pattern="^\+?\d{0,3}\s?\(?\d{4}\)?[-.\s]?\d{3}[-.\s]?\d{3}?" title="Must be Kenya MNO Numbers Only" placeholder="Enter Cellphone Number" required="required">
      </div> 
    <div class="form-group" style="padding-top: 8px; padding-bottom: 8px;">
