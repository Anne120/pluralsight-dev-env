...
<div id="modules" class="container text-center">
  ...
  <div class="row">
    <div class="col-sm-4">
      ...
      <p class="text-center para-padding">Security App caters for all visitors who come to visit our website. A proper record of the time in and time out is kept for security purposes. Using the module is very easy, simply click on Budget on Security app's navigation bar</p>
    </div>
    <div class="col-sm-4">
